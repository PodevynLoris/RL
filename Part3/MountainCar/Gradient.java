 ...
 * numSteps)</li>
 * <li>public static Color[] createGradient(Color one, Color two, int
 * numSteps)</li>
 * </ul>
 ...
 *
 * <p>
 * HeatMap is free software; you can redistribute it and/or modify
 ...
 *
 * <p>
 * HeatMap is distributed in the hope that it will be useful,
...
public class Gradient {
    ...
    /**
     * Produces a gradient through the rainbow: violet, blue, green, yellow, orange,
     * red
     */
     ...
     */
    public final static Color[] GRADIENT_HC = createMultiGradient(
            new Color[] { Color.red, Color.yellow, Color.blue, Color.white }, 4);
    ...
    public static Color[] createMultiGradient(Color[] colors, int numSteps) {
        ...
        // The final gradient will be made up of n 'sections', where n = colors.length -
        // 1
        ...
        for (int section = 0; section < numSections; section++) {
            // we divide the gradient into (n - 1) sections, and do a regular gradient for
            // each
